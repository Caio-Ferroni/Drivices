<x-header_admin pageTitle="Endereços" breadcrumb="Editar">
<x-content>

    <div class="d-flex align-items-center gap-3 mb-4">
        <a href="{{ route('enderecos.show', $endereco->id) }}" class="btn-dash-back">
    ...
    <div class="dash-card">
        ...
        <form action="{{ route('enderecos.update', $endereco->id) }}" method="POST" novalidate>
            @csrf
            @method('PUT')
                    ...
                    <div class="col-md-4">
                        <div class="dash-field @error('cep') has-error @enderror">
                            ...
                            <span class="dash-field-hint" id="cep-hint">
                                Digite um novo CEP para atualizar os campos automaticamente.
                            </span>
                            @error('cep')
                        ...
                        <div class="dash-field @error('unidade') has-error @enderror">
                            ...
                            <div class="dash-input-wrap">
                                ...
                                <input
                                    ...
                                    id="unidade"
                                    name="unidade"
                                    value="{{ old('unidade', $endereco->unidade) }}"
                        ...
                        <div class="dash-field @error('regiao') has-error @enderror">
                            ...
                            <div class="dash-input-wrap">
                                ...
                                <input
                                    ...
                                    id="regiao"
                                    name="regiao"
                                    value="{{ old('regiao', $endereco->regiao) }}"
                                    placeholder="Sudeste"
                                    autocomplete="off"
                                />
                            </div>
